...
#  Fonksiyon dışardan aldığı bu parametre değerlerini
#  kullanarak, min_sayi ve max_sayi aralığındaki bolunecek_sayi değerine bölünen sayıları bir diziye atayıp,
